...
#30,16.875,new_img_width,new_img_height:64*64にしたい
        ...
        new_height2 = height - 64

        height_split = int((height / new_img_height)+1) #17
        width_split = int((new_width / new_img_width)+1) #30#23
        height_split2 = int((new_height2 / new_img_height)+1) #16
        width_split2 = int((new_width2 / new_img_width)+1) #22

        for h in range(height_split2):
            if h ==15:
                height_start = (height - new_img_height)-32
                height_end = height_start + 64
            else:
